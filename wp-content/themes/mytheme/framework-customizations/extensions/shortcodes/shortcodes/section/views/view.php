...
$custom_class = ( isset( $atts['section_class'] ) && $atts['section_class'] ) ? ' ' . $atts['section_class'] . '' : '';
$custom_id = ( isset( $atts['section_id'] ) && $atts['section_id'] ) ? 'id="' . $atts['section_id'] . '"' : '';

?>
	<section <?php echo $custom_id ?> class="fsw-main-row <?php echo $custom_class ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
