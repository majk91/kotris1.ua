...
function mytheme_scripts() {
	...
	wp_enqueue_style( 'mytheme-theme-style', get_template_directory_uri() . '/css/myTheme.css' );//css include

	wp_enqueue_style( 'mytheme-theme-media', get_template_directory_uri() . '/css/media.css' );//css include

	wp_enqueue_style( 'mytheme-theme-style', get_template_directory_uri() . '/css/animate.css' );//css include
 ...
 * Load TGM Plugins.
 */
require get_template_directory() . '/tgm/example-mytheme.php';
...
register_sidebar( array(
'name'          => 'Область для виджетов в header',
...
register_sidebar( array(
'name'          => 'Область для виджетов в footer',
